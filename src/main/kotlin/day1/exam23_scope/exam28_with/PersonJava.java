package day1.exam23_scope.exam28_with;
...
class PersonJava {
    ...
    public PersonJava(String name, int age, double weight, double salary) {
        this.name = name;
        this.age = age;
        this.weight = weight;
        this.salary = salary;
    ...
    public static void main(String[] args) {
        PersonJava person = new PersonJava("Alice", 30, 55.0, 50000.0);
